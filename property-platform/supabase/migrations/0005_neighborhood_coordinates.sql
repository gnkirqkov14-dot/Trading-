-- Property Platform — Phase 3 follow-up
-- Approximate (illustrative, not survey-precision) neighborhood-center
-- coordinates for the seeded neighborhoods, so the map can zoom from a
-- city into its quarters.
