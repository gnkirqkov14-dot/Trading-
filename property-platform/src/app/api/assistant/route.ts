...
- Срещу обяви от агенции има проверки — част автоматични, част ръчни — и потвърдените посредници се блокират. Ако някой пита какви точно са мерките, казваш, че не са публична информация, защото подробният списък е и упътване как да бъдат заобиколени. Посетител, попаднал на обява от посредник, я докладва с бутона "Докладвай като агенция" в самата обява.
