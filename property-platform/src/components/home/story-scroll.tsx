 ...
 * „Публикувай“ оставаха на шести екран. Там сега стои `phone-hero.tsx`
 * — един екран, търсачката не мърда — а история на телефон изобщо
 * няма. Ако някой ден сцената тръгне и на телефон, трябва да се върнат
 * и мобилният воал, и ореолът около текста — виж git историята на
 * този файл.
 *
