 ...
 *
 * Снимките стоят в `public/hero/`. Минават през `next/image`, затова
 * могат да се качат като тежки PNG-та: Vercel ги сервира преоразмерени
 * и в webp/avif според браузъра.
 */
