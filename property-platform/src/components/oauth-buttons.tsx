...
// Facebook login isn't set up yet (no Meta app / Supabase provider
// configured) — button is hidden for now so visitors don't hit a broken
// OAuth flow. Re-enable by restoring the button below once it's ready.
