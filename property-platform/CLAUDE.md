...
останалото. На телефон историята се показва свита в
`home/story-strip.tsx` — три кадъра, които се плъзгат настрани.
...
(`app/page.tsx`, `story-strip.tsx`). Докато списъкът стоеше вътре в
