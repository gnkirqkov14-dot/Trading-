...
👉 **Собственикът на сайта гледа
[`docs/РЪЧНИ-СТЪПКИ.md`](docs/РЪЧНИ-СТЪПКИ.md)** — всички настройки,
които се правят с натискане на бутони във Vercel, Supabase, Resend и
Google, написани стъпка по стъпка.
